...
describe('#createElements', () => {
  ...
  describe('when the root has no edges', () => {
    ...
    const printer = new GraphGenerator<'cytoscape'>(registry, CytoscapeGraphStrategy)

    it('should return an empty array', () => {
      const elements = printer.createElements(root)
  ...
  describe('when the root has nested edges', () => {
    ...
    it('should return an array with nodes and edges', () => {
      const elements = generator.createElements(root)
  ...
  describe('when the several nodes shares some edges', () => {
    ...
    it('should return an array with nodes and edges', () => {
      const abouts = generator.createElements(about)
      const roots = generator.createElements(root)
      const elements = [...abouts, roots].flat()
